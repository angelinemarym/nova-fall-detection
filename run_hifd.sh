...
echo "========================================="
echo "Step 2: Traditional ML Experiments (HIFD)"
echo "========================================="
python3 -u ml_experiments_hifd.py
if [ $? -ne 0 ]; then
    echo "ERROR: ML Experiments failed. Continuing to DL..."
fi

echo "========================================="
echo "Step 3: Deep Learning Experiments (HIFD)"
echo "========================================="
